  ...
  return (
    <main className="page notes lab-note-page door-coverage-page">
      ...
      <p className="lede">
        ...
        are allowed. Related: <Link to="/door-waits">Door waits</Link>,{" "}
      ...
      <p>
        ...
        progressions on the two reduced classes below. Fixed-Q density as the window grows.
      </p>
      ...
      <p>
        Wait census through ten million:{" "}
        <Link to="/door-waits">Door waits</Link>. Coverage lattice and cube
        doors are thin siblings in Lab.
      </p>
      ...
      <p>
        ...
        every coverage census table and verifies the Proth certificate.
      </p>
    </main>
  );
}
