    ...
    <main className="page">
      ...
      <section className="hire-beat">
        ...
        <p>
          ...
          <Link to="/basins">Basins</Link> draws those drains; the dials below
          measure how the hire set grows once you open doors.
        </p>
      </section>
...
// muted line colour for layout (hoisted for shapes)