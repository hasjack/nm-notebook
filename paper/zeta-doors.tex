...
factorisations. Three plus-side candidates from the same
\texttt{lions71} hunt are certified and independently verified
(Mac Studio, Apple M2 Max, 12 cores, 32\,GB):
\begin{center}
\begin{tabular}{@{}rrrrl@{}}
\toprule
Digits of $Q_k$ & \path{cert.py} & $F$ primes ${}<2^{64}$ & Cofactors & \path{verify.py}\\
\midrule
18365 & 9 h 2 min & 1598 & 19 & 24 Sep 2026\\
16213 & 5 h 19 min & 1215 & 58 & 25 Sep 2026\\
16165 & 5 h 19 min & 1221 & 62 & 25 Sep 2026\\
\bottomrule
\end{tabular}
\end{center}
The 18365-digit index is $k=1522610689958516981964050$
(\path{lions71/hits.certified.jsonl}). The two smaller rows are
\path{lions71/hits.smaller.certified.jsonl}. In each case $F^2>N$ from the
64-bit part, and listed cofactors were proved from the factored index.

The source snapshot for this draft is 25 September 2026 \cite{repo}.
...
python3 verify.py lions71/hits.smaller.certified.jsonl
\end{verbatim}
...
of decimal digits in the note. All three \texttt{lions71} certificates
have been independently rechecked as above.
