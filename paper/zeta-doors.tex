...
$k=1522610689958516981964050$ is now certified
(\path{lions71/hits.certified.jsonl}): 1598 factors of $N-1$ below $2^{64}$,
19 listed cofactors, and $F^2>N$ from the 64-bit part. Independent
\path{verify.py} on that row has not been repeated in this draft.

The source snapshot for this draft is repository revision
\texttt{c04d373} \cite{repo}. Change into the directory
\begin{center}
